...
const handlers = {
    ...
    // Usado para fotos, arquivos, imagens, assinatura digitais e chaves criptograficas, que são armazenados como bytes no banco de dados. O XML não suporta tipos binários, então eles são convertidos para strings em base64, que é um formato de texto seguro para transmitir dados binários.
};
